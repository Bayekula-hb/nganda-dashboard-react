...
export const columns: ColumnDef<Sale>[] = [
  ...
  },
  {
    ...
    header: "Total payé",
    cell: ({ row }) => {
      const drink_price: number = JSON.parse(row.getValue("drink_price"));
      const sale_quantity: number = JSON.parse(row.getValue("sale_quantity"));
      return <div className="capitalize">{sale_quantity * drink_price} Fc</div>
    },
  },
  {
    accessorKey: "sale_created_at",
    header: "Date du vente",
    cell: ({ row }) => (
...
export function SaleList({ saleProducts } : { saleProducts : Sale[]}) {
